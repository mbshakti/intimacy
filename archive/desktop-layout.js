  ...
  items: {
    ...
    intro: [
      ...
      { type: 'character',  y: 100, x: 200, char: 'priest',
        label: 'judgemental_priest.json',           meta: '706 tokens', portrait: '/img/icons/judgemental-priest.png' },
    ...
    community: [
      ...
      { type: 'link', y: 880,  x: 300,  key: 'guide-trappu',   url: 'https://wikia.schneedc.com/bot-creation/trappu/creation',
        label: "trappu's plist + ali:chat",        meta: 'how to write a character' },
      { type: 'link', y: 1000, x: 600,  key: 'guide-alicat',   url: 'https://rentry.co/alichat',
        label: "alicat's ali:chat style",          meta: 'the format everyone else built on' },
      { type: 'link', y: 1120, x: 900,  key: 'guide-kingbri',  url: 'https://rentry.co/kingbri-chara-guide',
        label: "kingbri's minimalistic",           meta: 'same idea, half the length' },
      { type: 'link', y: 1240, x: 300,  key: 'guide-kuma',     url: 'https://rentry.co/WPP_For_Dummies',
        label: "kuma's w++ for dummies",           meta: 'step-by-step template for beginners' },
      { type: 'link', y: 1360, x: 600,  key: 'guide-junko',    url: 'https://rentry.org/create-a-character-for-fucking-idiots',
        label: "junko's guide for idiots",         meta: '43,725 views on a pastebin' },
      { type: 'link', y: 1480, x: 900,  key: 'guide-chai',     url: 'https://rentry.co/chai-pygmalion-tips',
        label: "chai's pygmalion tips",            meta: 'what actually works and why' },
      { type: 'link', y: 1600, x: 300,  key: 'guide-char-creation', url: 'https://www.reddit.com/r/CharacterAI/comments/12kcsej/mega_character_creation_guide/',
    ...
    craft: [
      ...
      { type: 'character',    y: 220,  x: 950, char: 'chloe',
        label: 'expressionless_woman.json',                    meta: '736 tokens', portrait: '/img/icons/expressionless-woman.png' },
      { type: 'character',    y: 340,  x: 200, char: 'eleanor',
        label: 'rich_dommy_mommy_who_takes_care_of_you.json',  meta: '852 tokens', portrait: '/img/icons/rich-dommy-mommy.png' },
      { type: 'character',    y: 460,  x: 700, char: 'victoria',
        label: 'evil_bully_wife.json',                         meta: '710 tokens', portrait: '/img/icons/evil-bully-wife.png' },
      { type: 'character',    y: 580,  x: 400, char: 'logan',
        label: 'traumatized_military_man.json',                meta: '775 tokens', portrait: '/img/icons/traumatized_military_man.png' },
      { type: 'character',    y: 700,  x: 900, char: 'luna',
        label: 'mental_chastity_girlfriend.json',              meta: '965 tokens', portrait: '/img/icons/mental-chastity-girlfriend.png' },
      { type: 'character',    y: 820,  x: 200, char: 'minho',
        label: 'loving_korean_boyfriend.json',                 meta: '764 tokens', portrait: '/img/icons/loving-korean-boyfriend.png' },
      { type: 'character',    y: 940,  x: 600, char: 'parents',
        label: 'mentally_unwell_dad_and_stressed_mom.json',    meta: '1752 tokens', portrait: '/img/icons/stressed_parents.png' },
